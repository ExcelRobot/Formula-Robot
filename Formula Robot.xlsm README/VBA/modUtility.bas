...
Public Sub AssignFormulaIfErrorPrintIntoDebugWindow(ByVal PutFormulaOnCell As Range _
    ...
    PutFormulaOnCell.Formula2 = VBA.Replace(FormulaText, NEW_LINE, Chr$(10))
    Exit Sub
